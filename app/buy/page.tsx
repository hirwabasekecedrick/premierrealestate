...
function BuyPageContent() {
    ...
    const filteredProperties = useMemo(() => {
        let result = BUY_PROPERTIES.filter(p =>
    ...
    return (
        <div className="pb-20 bg-background min-h-screen">
            ...
            <div className="bg-secondary py-16 text-center text-white mb-10 px-4 relative overflow-hidden">
                ...
                <h1 className="text-4xl md:text-5xl font-heading font-bold mb-4 relative z-10 tracking-tight">Properties for Sale</h1>
                <p className="text-lg max-w-2xl mx-auto text-gray-300 relative z-10">
                    Invest in your future with our curated selection of properties for sale in Kigali.
                </p>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="mb-8 flex justify-between items-center">
                    <p className="text-muted font-medium">
                        Found <span className="text-secondary font-bold">{filteredProperties.length}</span> properties match your criteria
                    </p>
                ...
                {filteredProperties.length > 0 ? (
                    ...
                    <div className="text-center py-20 bg-gray-50 rounded-3xl border-2 border-dashed border-border">
                        ...
                        <h3 className="text-2xl font-heading font-bold text-secondary mb-2">Oops! No properties found</h3>
                        <p className="text-muted">We couldn't find any properties matching your search. Try different keywords or filters.</p>
                        <button
                            onClick={() => {
                                setSearchQuery("");
...
export default function BuyPage() {
    return (
        <Suspense fallback={<div className="min-h-screen py-20 text-center">Loading properties...</div>}>
            <BuyPageContent />
        </Suspense>
    );
}
