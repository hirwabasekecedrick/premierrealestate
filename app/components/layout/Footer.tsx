...
import { Facebook, Twitter, Instagram, Linkedin, MapPin, Phone, Mail, ArrowRight, Search } from "lucide-react";
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                    ...
                    <div className="space-y-4">
                        ...
                        <p className="text-gray-400 leading-relaxed">
                            Find your dream home in Kigali. We offer premium properties, luxury homes, and the best real estate services in Rwanda.
                        </p>
                        <div className="flex space-x-4 pt-2">
                            ...
                            <a
                                href="https://x.com/EstatePremier"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-primary transition-colors text-white"
                            >
                            ...
                            <a
                                href="https://www.tiktok.com/@premier_real_estate"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-primary transition-colors text-white"
                            >
                    ...
                    <div className="relative">
                        ...
                        <div className={`absolute top-[4.5rem] left-0 right-0 mt-2 bg-white rounded-xl shadow-2xl overflow-hidden z-50 transition-all duration-300 transform origin-top ${showRecommendations && searchQuery ? 'scale-y-100 opacity-100' : 'scale-y-0 opacity-0 pointer-events-none'}`}>
                            {filteredAssets.length > 0 ? (
                                <ul className="max-h-64 overflow-y-auto custom-scrollbar">
                                    {filteredAssets.map(asset => (
                                        <li key={asset.id}>
                                            <Link href={`/properties/${asset.id}`} className="block px-4 py-3 hover:bg-gray-50 border-b border-gray-100 transition-colors">
                                                <span className="block text-secondary font-semibold text-sm mb-0.5">{asset.title}</span>
                                                <span className="text-[10px] text-primary font-bold uppercase tracking-wider">{asset.type}</span>
                                            </Link>
                                        </li>
                                    ))}
                                </ul>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            <li className="flex items-start gap-4">
                                ...
                                <span className="text-gray-400">KN 5 Rd, Kigali Heights<br />Kigali, Rwanda</span>
                            </li>
                            <li className="flex items-center gap-4">
                                <Phone className="text-primary shrink-0" size={20} />
                                <span className="text-gray-400">+250 788 000 000</span>
                            </li>
                            <li className="flex items-center gap-4">
                                <Mail className="text-primary shrink-0" size={20} />
                                <span className="text-gray-400">info@premierrealestate.co.rw</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div>
                        ...
                        <p className="text-gray-400 mb-4">
                            Subscribe to get the latest property news and listings delivered to your inbox.
                        </p>
                ...
                <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                    <p className="text-gray-500 text-sm">
                        &copy; {new Date().getFullYear()} Premier Real Estate. All rights reserved.
                    </p>
                </div>
            </div>
        </footer>
